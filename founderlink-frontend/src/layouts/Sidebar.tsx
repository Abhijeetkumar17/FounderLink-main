...
const Sidebar = () => {
  ...
  const founderLinks = [
    ...
    { to: '/founder/startups/browse',   icon: <Search size={18} />,          label: 'Browse Startups' },
  ...
  const coFounderLinks = [
    ...
    { to: '/cofounder/invitations', icon: <Mail size={18} />,           label: 'My Invitations' },
  ];
  ...
  return (
    <aside className="w-60 h-full shrink-0 bg-dark-800 border-r border-dark-500 flex flex-col sticky top-0">
